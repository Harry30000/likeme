...
@section('sidebar-menu')
    <li class="active"><a href="{{ url('/home') }}"><i class="fa fa-fw fa-dashboard"></i> <span>Dashboard</span></a></li>
...
@section('content-header')
    <h1>
        ...
        <small>{{ $page_description or "Control panel" }}</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-danger">
                        ...
                        <div class="box-footer text-center">
                            <a href="{{ url('home/admin/users') }}" class="uppercase">View All Users</a>
                        </div>
                        <!-- /.box-footer -->
                    </div>
                    <!--/.box -->
