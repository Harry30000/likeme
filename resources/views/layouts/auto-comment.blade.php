...
@section('sidebar-menu')
    ...
    <li class="active"><a href="{{ url('/home/tang-comment') }}"><i class="fa fa-fw fa-commenting"></i> <span>Tăng Comment</span></a></li>
@endsection
<!-- Content Header (Page header) -->
@section('content-header')
    <h1>
        {{ $page_title or "Dashboard" }}
        <small>{{ $page_description or "Tăng Comment" }}</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{{ url('dashboard') }}"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Tăng Comment</li>
    </ol>
@endsection
                ...
                <form accept-charset="UTF-8" method="post">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="message" name="message" rows="10" placeholder="Mỗi Comment cách nhau bởi dấu xuống dòng ..."></textarea>
                        </div>
                    </div>
                    <!-- /.box-body -->
                    <div class="box-footer">
                        <div class="col-md-6 col-md-offset-3">
                            <button type="button" class="btn btn-success btn-block btn-flat ajax" id="comment"
                                    data-loading-text="<i class='fa fa-spin fa-refresh'></i> Đang Auto Comment">
                                Submit
                            </button>
